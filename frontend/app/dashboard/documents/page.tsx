...
function DocumentVaultContent() {
  ...
  async function handleReupload(doc: ActifyDocument, file: File) {
    ...
    try {
      ...
      await load();
    } catch { alert('Errore durante il caricamento'); }
        ...
        <div style={{ display: 'flex', alignItems: 'flex-start', gap: 18, marginBottom: 24 }}>
          ...
          <div style={{ flex: 1 }}>
            ...
            <p style={{ fontSize: 13.5, color: 'var(--text2)', lineHeight: 1.7, margin: 0 }}>
              ...
              Scarica i PDF direttamente da questa pagina e presentali alle autorità di vigilanza come prova documentale
                    ...
                    return (
                      <div
                        ...
                        style={{
                          ...
                          gap: 16,
                          padding: '18px 24px',
                          borderBottom: idx < groupDocs.length - 1 ? '1px solid rgba(255,255,255,.06)' : 'none',
                        }}
                      >
                        {/* Status dot */}
                        <div style={{
                        ...
                        <div style={{ flex: 1, minWidth: 0 }}>
                          ...
                          <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap' }}>
                            ...
                            {doc.finalized_at && (
                              <span style={{ fontSize: 11, color: 'var(--dim)' }}>Approvato {fmtDate(doc.finalized_at)}</span>
                            )}
                          </div>
